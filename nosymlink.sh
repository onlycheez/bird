...
LIBSOURCES="missing.h krt-sys.h krt-win.c sysio.h"
...
LIBSOURCES="timer.h endian.h unix.h log.c io.c random.c krt.h krt.c main.c"

for LIBSOURCE in $LIBSOURCES; do
  rm "obj/lib/${LIBSOURCE}"
  cp "sysdep/unix/${LIBSOURCE}" "obj/lib/${LIBSOURCE}"
done
